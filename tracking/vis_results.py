...
from core.vis.visdom_cus import Visdom

env_path = os.path.join(os.path.dirname(__file__), '../core')
if env_path not in sys.path:
    sys.path.append(env_path)

from core.test.evaluation import trackerlist, get_dataset
...
if __name__ == '__main__':
    ...
    trackers.extend(
        trackerlist(name='custrack', parameter_name='vitb_256_mae_ce_32x4_clust_ep100', dataset_name=dataset_name,
                    run_ids=None, display_name='CUSTrack256'))
