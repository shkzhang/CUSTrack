...
"""
Add default config for CUSTrack.
"""
cfg = edict()
...
cfg.MODEL.MAX_HISTORY_LENGTH = 5
cfg.MODEL.FEATURE_TOKEN_LENGTH = 1
# MODEL.BACKBONE
...
cfg.MODEL.CAUSAL = edict()
cfg.MODEL.CAUSAL.BRANCH = 'UTP'
cfg.MODEL.CAUSAL.ASSUMPTION = 'Learnable'
cfg.MODEL.CAUSAL.GRAPH = 'Full'
...
cfg.TRAIN.KL_WEIGHT = 0.2
cfg.TRAIN.T_BRANCH_WEIGHT = 0.1
cfg.TRAIN.U_BRANCH_WEIGHT = 0.2
cfg.TRAIN.K_BRANCH_WEIGHT = 0.2
cfg.TRAIN.FUSION_WEIGHT = 0.2
...
cfg.TRAIN.CHECKPOINT_EPOCH_INTERVAL = 5
...
cfg.DATA.TRAIN.DATASETS_NAME = ["CLUST_train", "NDTH_train"]
cfg.DATA.TRAIN.DATASETS_RATIO = [1, 1]
cfg.DATA.TRAIN.SAMPLE_PER_EPOCH = 60000
cfg.DATA.TRAIN.NEGATIVE_PAIR_RATIO = 0.1
cfg.DATA.TRAIN.SEQ_ENHANCE_RATIO = 0.1
# DATA.VAL
cfg.DATA.VAL = edict()
...
cfg.TEST.EPOCH = 500
cfg.TEST.CUSTOM_CKPT_DIR = False
cfg.TEST.CKPT_DIR = None
