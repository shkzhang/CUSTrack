...
import importlib
from core.test.evaluation.data import SequenceList

DatasetInfo = namedtuple('DatasetInfo', ['module', 'class_name', 'kwargs'])

pt = "core.test.evaluation.%sdataset"  # Useful abbreviations to reduce the clutter

dataset_dict = dict(
    clust=DatasetInfo(module=pt % "clust", class_name="CLUSTDataset", kwargs=dict(split='test')),
    clust_train=DatasetInfo(module=pt % "clust", class_name="CLUSTDataset", kwargs=dict(split='train')),
    clust_CIL=DatasetInfo(module=pt % "clust", class_name="CLUSTDataset", kwargs=dict(split='CIL')),
    clust_ETH=DatasetInfo(module=pt % "clust", class_name="CLUSTDataset", kwargs=dict(split='ETH')),
    clust_ICR=DatasetInfo(module=pt % "clust", class_name="CLUSTDataset", kwargs=dict(split='ICR')),
    clust_MED=DatasetInfo(module=pt % "clust", class_name="CLUSTDataset", kwargs=dict(split='MED')),

    ndth=DatasetInfo(module=pt % "ndth", class_name="NDTHDataset", kwargs=dict(split='test')),
    ndth_train=DatasetInfo(module=pt % "ndth", class_name="NDTHDataset", kwargs=dict(split='train')),
    ndth_small=DatasetInfo(module=pt % "ndth", class_name="NDTHDataset", kwargs=dict(split='test_small')),
    ndth_big=DatasetInfo(module=pt % "ndth", class_name="NDTHDataset", kwargs=dict(split='test_big')),
